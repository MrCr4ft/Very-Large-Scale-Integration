...
#Best model without rotation with symmetry breaking
...
#Best model with rotation with symmetry breaking
...
#Best model without rotation with symmetry breaking
python ./solve_instances_minizinc.py --instances-input-dir="$INSTANCES_DIR/dzn" --model-filepath="./cp/best_model_sb.mzn" --solutions-output-dir="$SOLUTIONS_DIR/cp_best_model_sb/gecode/" --stats-output-csv-file="$SOLUTIONS_DIR/cp_best_model_sb/gecode/stats.csv" --solver="gecode" --timeout-ms=$TIME_LIMIT --draw-solutions=False
#Best model with rotation with symmetry breaking
...
#SMT
#SMTNoRotationWithZ3
python ./solve_instances_sat_milp_smt.py --instances-input-dir="$INSTANCES_DIR/json" --solutions-output-dir="$SOLUTIONS_DIR/smt_no_rotation_z3_sb" --stats-output-csv-file="$SOLUTIONS_DIR/smt_no_rotation_z3_sb/stats.csv" --timeout-ms=$TIME_LIMIT --model-name=SMT --activate-symmetry-breaking=True --draw-solutions=False --solver-for-smt=z3 --enable-cumulative-constraints-smt=True --allow-rotation-smt=False
#SMTNoRotationWithCVC5
python ./solve_instances_sat_milp_smt.py --instances-input-dir="$INSTANCES_DIR/json" --solutions-output-dir="$SOLUTIONS_DIR/smt_no_rotation_cvc5_sb" --stats-output-csv-file="$SOLUTIONS_DIR/smt_no_rotation_cvc5_sb/stats.csv" --timeout-ms=$TIME_LIMIT --model-name=SMT --activate-symmetry-breaking=True --draw-solutions=False --solver-for-smt=cvc5 --enable-cumulative-constraints-smt=True --allow-rotation-smt=False
#SMTRotationWithZ3
python ./solve_instances_sat_milp_smt.py --instances-input-dir="$INSTANCES_DIR/json" --solutions-output-dir="$SOLUTIONS_DIR/smt_with_rotation_z3_sb" --stats-output-csv-file="$SOLUTIONS_DIR/smt_with_rotation_z3_sb/stats.csv" --timeout-ms=$TIME_LIMIT --model-name=SMT --activate-symmetry-breaking=True --draw-solutions=False --solver-for-smt=z3 --enable-cumulative-constraints-smt=True --allow-rotation-smt=True
#SMTRotationWithCVC5
